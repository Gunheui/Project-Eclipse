...
{
    /// <summary>
    /// 스테이지 선택 목록의 셀 하나에 대응하는 경량 ViewModel. 스테이지 정의·번호는 고정이고,
    ...
    {
        /// <param name="stage">이 셀이 표시할 스테이지 정의(썸네일·이름·보스 여부의 원천).</param>
        /// <param name="stageNumber">1-기반 스테이지 번호. 셀 번호 뱃지 표기이자 잠금 계산의 인덱스(번호−1) 기준.</param>
        ...
        /// <summary> 이 셀이 표시할 스테이지 정의. 셀 수명 내내 불변. </summary>
        public StageSO Stage { get; }

        /// <summary> 1-기반 스테이지 번호(뱃지 표기 "01" 등). 셀 수명 내내 불변. </summary>
        public int StageNumber { get; }

        /// <summary> 셀의 3상태. 장 진행도가 바뀌면 갱신된다. Locked면 선택 불가·잠금 오버레이 표시. </summary>
