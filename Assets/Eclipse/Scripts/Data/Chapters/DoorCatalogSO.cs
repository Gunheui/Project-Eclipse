...
{
    /// <summary> 약속 문 8종. 값은 카탈로그 배열 인덱스와 무관한 식별자다. </summary>
    public enum DoorKind { Attack, Guard, Haste, Bond, Curse, Gold, Manual, Essence }
    ...
    /// <summary>
    /// 약속 문 카탈로그(단일 에셋). 문 8종 정의와 재화 문 지급 공식 계수를 보유한다 —
